...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TaskX" },
      { name: "twitter:title", content: "TaskX" },
      { name: "description", content: "TaskX is the personal daily workspace for cybersecurity pros." },
      { property: "og:description", content: "TaskX is the personal daily workspace for cybersecurity pros." },
      { name: "twitter:description", content: "TaskX is the personal daily workspace for cybersecurity pros." },
